...
tk.Button(root, text="Прекратить слушать", command=stop_listening).pack(pady=10)

# Кнопка для продолжения слушания
tk.Button(root, text="Продолжить диалог", command=continue_listening).pack(pady=10)
