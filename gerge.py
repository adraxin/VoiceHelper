...
opts = {
    ...
    "cmds": {
        ...
        "weather": ('какая погода', 'скажи погоду', 'какая погода сегодня', 'прогноз погоды')
    }
}
...
def get_weather(city):
    api_key = "6320a948fc8e1c7d7b485412f623481d"  # Замените на ваш ключ OpenWeatherMap
    ...
    try:
        ...
        if data["cod"] != 200:
            return "Извините, я не смог найти информацию о погоде."
        ...
        return f"Сейчас в городе {city_name} {description}. Температура {temp} градусов, ощущается как {feels_like} градусов."
    ...
    if cmd == 'ctime':
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                speak("Извините, я не смог распознать название города.")
            except sr.RequestError:
                speak("Извините, произошла ошибка при получении данных.")
    else:
